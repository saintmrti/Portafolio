  ...
  return (
      <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
          ...
          <ul className={!nav ? "hidden" : "absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center"}>
              <li className='py-6 text-4xl hover:text-pink-600'><Link onClick={handleClick} to='home' smooth={true} duration={1000}>Home</Link></li>
              ...
              <ul>
                  <li className="w-[160px] h-[60px] flex justify-between items-center lg:ml-[-100px] ml-[-120px] hover:ml-[-10px] duration-300 bg-blue-800">
                      <a className="flex justify-between items-center w-full text-gray-300" href="https://www.linkedin.com/in/saintmartin/" target="_blank" rel="noreferrer">
                          LinkedIn <FaLinkedin className="lg:w-[30px] lg:h-[30px] w-[15px] h-[15px]"/>
                      </a>
                  </li>
                  ...
                  <li className="w-[160px] h-[60px] flex justify-between items-center lg:ml-[-100px] ml-[-120px] hover:ml-[-10px] duration-300 bg-black">
                      <a className="flex justify-between items-center w-full text-gray-300" href="https://github.com/saintmrti" target="_blank" rel="noreferrer">
                          GitHub <FaGithub className="lg:w-[30px] lg:h-[30px] w-[15px] h-[15px]"/>
                      </a>
                  </li>
                  <li className="w-[160px] h-[60px] flex justify-between items-center lg:ml-[-100px] ml-[-120px] hover:ml-[-10px] duration-300 bg-green-500">
                      <a className="flex justify-between items-center w-full text-gray-300" href="https://wa.me/2288548416" target="_blank" rel="noreferrer">
                          WhatsApp <FaWhatsapp className="lg:w-[30px] lg:h-[30px] w-[15px] h-[15px]"/>
                      </a>
                  </li>
                  <li className="w-[160px] h-[60px] flex justify-between items-center lg:ml-[-100px] ml-[-120px] hover:ml-[-10px] duration-300 bg-[#565f69]">
                      <a className="flex justify-between items-center w-full text-gray-300" href="https://drive.google.com/file/d/1m3yEkoSnC9Ieh5xltfMA4g9MGLtCmokf/view?usp=sharing" target="_blank" rel="noreferrer">
                          Curriculum <BsFillPersonLinesFill className="lg:w-[30px] lg:h-[30px] w-[15px] h-[15px]"/>
                      </a>
                  </li>
              </ul>
          </div>
